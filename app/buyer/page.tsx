...
// ─────────────────────────────────────────────────────────────────
// ALL SELLERS & THEIR PRODUCTS — single source of truth
// Add new seller products here and they auto-appear on buyer page
// ─────────────────────────────────────────────────────────────────
const SELLERS = [
    {
        id:1, name:'Meena Crafts', location:'Jaipur, Rajasthan',
        accent:'#f97316', category:'handicraft',
    ...
    },
    {
        ...
        accent:'#a78bfa', category:'textile',
    ...
    },
    {
        ...
        accent:'#00e5ff', category:'textile',
    ...
    },
    {
        ...
        accent:'#eab308', category:'jewellery',
    ...
    },
    {
        ...
        accent:'#22d3ee', category:'pottery',
    ...
    },
    {
        ...
        accent:'#f472b6', category:'handicraft',
...
// Flat product list derived from SELLERS — no duplication
const ALL_PRODUCTS = SELLERS.flatMap(s =>
    s.products.map(p => ({
        ...p,
        sellerName:     s.name,
...
function CartDrawer({ cart, onClose, onQty, onRemove }: {
    ...
    const items = cart.map(c => ({ ...c, p: ALL_PRODUCTS.find(x => x.id === c.id)! })).filter(c => c.p);
                    ...
                    <div className="fu1" style={{ position:'relative', overflow:'hidden', borderRadius:6, marginBottom:20, padding:'26px 30px', background:C.bgCard, border:`1px solid rgba(0,229,255,0.12)` }}>
                        ...
                        <div style={{ position:'relative', maxWidth:520 }}>
                            ...
                            <div style={{ display:'flex', gap:20, flexWrap:'wrap' }}>
                                {[{ v:`${ALL_PRODUCTS.length}`, l:'Products' }, { v:`${SELLERS.length}`, l:'Sellers' }, { v:`${CATEGORIES.length - 1}`, l:'Categories' }].map(s => (
